...
export const mockAlat: Alat[] = [
  {
    id: '1',
    namaAlat: 'Total Station Topcon',
    kategori: 'Survey',
    merk: 'Topcon',
    spesifikasi: 'ES-105, Akurasi 5", Range 5000m',
    kondisi: 'baik',
    status: 'dipinjam',
    lokasiTerakhir: 'Gudang A',
    jumlahTotal: 3,
    jumlahTersedia: 1,
    gambarList: [
    ...
    peminjam: [
      {
        nama: 'Ahmad Rizki',
        tanggalPinjam: '2025-01-20',
        estimasiKembali: '2025-01-27',
        jumlahDipinjam: 2
      }
    ],
  ...
  {
    id: '2',
    namaAlat: 'Drone DJI Phantom 4 Pro',
    kategori: 'Aerial Survey',
    merk: 'DJI',
    spesifikasi: '20MP Camera, 4K Video, Flight Time 30min',
    kondisi: 'baik',
    status: 'tersedia',
    lokasiTerakhir: 'Gudang B - Rak 3',
    jumlahTotal: 2,
    jumlahTersedia: 2,
    gambarList: [
  ...
  {
    id: '3',
    namaAlat: 'GPS Geodetic Trimble',
    kategori: 'Survey',
    merk: 'Trimble',
    spesifikasi: 'R12i, RTK, Multi-GNSS',
    kondisi: 'baik',
    status: 'dipinjam',
    lokasiTerakhir: 'Proyek Jalan Tol KM 45',
    jumlahTotal: 5,
    jumlahTersedia: 2,
    gambarList: [
      'https://images.unsplash.com/photo-1590935216538-eba5e474c5be?w=800&h=600&fit=crop',
    ],
    peminjam: [
      {
        nama: 'Budi Santoso',
        tanggalPinjam: '2025-01-18',
        estimasiKembali: '2025-02-05',
        jumlahDipinjam: 2
      },
      {
        nama: 'Siti Nurhaliza',
        tanggalPinjam: '2025-01-22',
        estimasiKembali: '2025-01-29',
        jumlahDipinjam: 1
      }
    ],
  ...
  {
    id: '4',
    namaAlat: 'Soil Test Kit',
    kategori: 'Testing',
    merk: 'Geotest',
    spesifikasi: 'Complete Set: pH, Moisture, Compaction',
    kondisi: 'baik',
    status: 'tersedia',
    lokasiTerakhir: 'Lab Mekanika Tanah',
    jumlahTotal: 4,
    jumlahTersedia: 4,
    gambarList: [
  ...
  {
    id: '5',
    namaAlat: 'Theodolite Digital',
    kategori: 'Survey',
    merk: 'Nikon',
    spesifikasi: 'NE-100, 5" Accuracy',
    kondisi: 'maintenance',
    status: 'diperbaiki',
  ...
  },
  {
    ...
    kategori: 'Testing',
    merk: 'Schmidt',
    spesifikasi: 'Type N, Digital Display',
    kondisi: 'baik',
    status: 'dipinjam',
    lokasiTerakhir: 'Proyek Gedung ABC',
    jumlahTotal: 6,
    jumlahTersedia: 3,
    gambarList: [
      'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&h=600&fit=crop',
  ...
  {
    id: '7',
    namaAlat: 'Digital Level',
    kategori: 'Survey',
    merk: 'Sokkia',
    spesifikasi: 'SDL30, Automatic, IP66',
    kondisi: 'baik',
    status: 'tersedia',
    lokasiTerakhir: 'Gudang A - Rak 2',
    jumlahTotal: 3,
    jumlahTersedia: 3,
    gambarList: [
      'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=800&h=600&fit=crop',
  ...
  {
    id: '8',
    namaAlat: 'Laser Scanner 3D',
    kategori: 'Aerial Survey',
    merk: 'Leica',
    spesifikasi: 'BLK360, Range 60m, Accuracy 4mm',
    kondisi: 'baik',
    status: 'dipinjam',
    lokasiTerakhir: 'Proyek Heritage Building',
    jumlahTotal: 1,
    jumlahTersedia: 0,
    gambarList: [
      'https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=800&h=600&fit=crop',
